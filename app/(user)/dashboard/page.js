...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {/* Tablet UI */}
      <div
      className="w-full h-full not-md:hidden lg:hidden flex flex-col gap-3 p-8">
        ...
        {/* Total Net Balance */}
          <div 
          className={`${(user.lend + user.owe) >=0 ? "bg-[#2C9986]" : "bg-red-500"} w-full flex flex-col justify-center items-center gap-3 rounded-xl shadow-md py-7 h-80`}>
